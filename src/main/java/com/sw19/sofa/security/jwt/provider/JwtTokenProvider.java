...
import static com.sw19.sofa.infra.redis.constants.RedisPrefix.*;
...
public class JwtTokenProvider {
	...
	public boolean validateToken(String token) {
		...
		try {
			...
			return !claimsBody.getExpiration().before(new Date()) && claimsBody.get(TOKEN_TYPE.getValue(), String.class)
				.equals(ACCESS_TOKEN_TYPE.getValue());
