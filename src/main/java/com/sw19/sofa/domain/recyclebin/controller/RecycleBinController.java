...
public class RecycleBinController implements RecycleBinApi {
	...
	public ResponseEntity<ListRes<RecycleBinLinkCardRes>> getLinkCardListInRecycleBin(
		@AuthMember Member member, @RequestParam(name = "sortBy") RecycleBinSortBy recycleBinSortBy,
		@RequestParam SortOrder sortOrder, @RequestParam String lastId, @RequestParam int limit
	) {
		ListRes<RecycleBinLinkCardRes> res = recycleBinManageService.getLinkCardListInRecycleBin(member,
			recycleBinSortBy, sortOrder, lastId, limit);
