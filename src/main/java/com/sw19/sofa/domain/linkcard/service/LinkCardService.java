...
public class LinkCardService {
	...
	public ListRes<LinkCard> getLinkCardSimpleResListByFolderIdAndSortCondition(List<Long> folderIdList, SortBy sortBy,
		SortOrder sortOrder, int limit, Long lastId) {
		List<LinkCard> linkCardList = linkCardRepository.findAllByFolderIdAndSortCondition(folderIdList, sortBy,
			sortOrder, limit, lastId);
	...
	public ListRes<LinkCard> getLinkCardSimpleResListByLinkCardTagAndSortCondition(LinkCardTag linkCardTag,
		SortBy sortBy, SortOrder sortOrder, int limit, Long lastId) {
		List<LinkCard> linkCardList = linkCardRepository.findAllByLinkCardTagAndSortCondition(linkCardTag, sortBy,
			sortOrder, limit, lastId);
	...
	@Transactional
	public void deleteLinkCardList(List<LinkCard> linkCardList) {
		linkCardRepository.deleteAll(linkCardList);
	}
	...
	public List<LinkCard> getExpiredLinkCardsInRecycleBin() {
		return linkCardRepository.findExpiredLinkCardListInRecycleBin(getThirtyDaysAgoDateTime(),
			Constants.recycleBinName);
	}
