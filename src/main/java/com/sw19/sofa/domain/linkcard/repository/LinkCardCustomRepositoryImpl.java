...
import static com.sw19.sofa.domain.linkcard.entity.QLinkCard.*;
import static com.sw19.sofa.domain.linkcard.entity.QLinkCardTag.*;
...
public class LinkCardCustomRepositoryImpl implements LinkCardCustomRepository {
	...
	@Override
	public List<LinkCard> findAllByFolderIdAndSortCondition(List<Long> folderIdList, SortBy sortBy, SortOrder sortOrder,
		int limit, Long lastId) {
	...
	@Override
	public List<LinkCard> findAllByLinkCardTagAndSortCondition(LinkCardTag tag, SortBy sortBy, SortOrder sortOrder,
		int limit, Long lastId) {
		return jpaQueryFactory.selectFrom(linkCard)
			.leftJoin(linkCard.article).fetchJoin()
			.leftJoin(linkCard.folder).fetchJoin()
